...
(async () => {
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .overlay { position:absolute; inset:0; background:linear-gradient(70deg, rgba(23,23,150,0.82) 0%, rgba(23,23,150,0.78) 38%, rgba(23,23,150,0.25) 60%, rgba(23,23,150,0) 80%); }
    .content {
